...
const PagesButtons = () => {
  return (
    ...
    >
      ...
      text-customWhite hover:scale-[0.95] active:scale-100 duration-150"
      ...
      <a
        className="md:px-[0.5rem] px-2 md:py-[0.313rem] py-1 lg:text-[1rem] md:text-[0.875rem] text-sm md:font-semibold flex items-center justify-center rounded-[10px] text-pink-primary border-pink-primary border-2 hover:scale-[0.95] active:scale-100 duration-150"
